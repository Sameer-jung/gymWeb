...
<?php } ?>
    ...
    <header class="section__container header__container">
      <div class="header__content">
        ...
        <p>
        Unlock your potential and embark on a journey towards becoming a stronger, more confident version of yourself. 
        Enroll in our Martial Arts Program today and experience the remarkable transformation that martial arts can bring to your life!
        </p>
    ...
    <section class="section__container class__container" id="service">
      ...
      <div class="class__content" >
        <h2 class="section__header">Classes</h2>
        <p>
        ...
        <button id="showTimetableButton" class="btn" onclick="showPopup()">Show Timetable</button>
      </div>
    </section>
