...
// Check if registration was successful and display a message
if (isset($_SESSION['registration_success']) && $_SESSION['registration_success'] === true) {
  $registration_message = "Registered successfully. You can now log in.";
  // Unset the session variable to prevent showing the message again
...
<div class="login-container">
    ...
    <div class="input-error-container">
        <input type="text" id="identifier" name="identifier" placeholder="Email" required>
        <?php
        echo "<p class='error'>";
